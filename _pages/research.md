...
## Gravitational Waves (GWs) from EMRIs
------
EMRIs are one of the primary targets for space-based millihertz gravitational-wave (GW) detectors such as the Laser Interferometer Space Antenna (LISA), TianQin (天琴), and Taiji (太极).. As seen in FIG. 2, EMRIs have complex orbits, but what makes them so remarkable is their gravitational-wave (GW) signals, as this would allow us to test physics near a MBH. EMRI orbits have 2 phases: the inspiral and the plunge. The adiabatic inspiral phase, where the secondary is on a stable orbit and slowly inspirals towards a MBH due to GW radiation.
...
As seen in FIG. 3, for EMRIs on eccentric orbits, the GW signal peaks when the secondary is at periapsis, and the converse occurs at apoapsis. This creates a distinctive "beating" pattern, and given the long orbital timescales, we expect EMRIs' signals to be distinct from other sources. Based on loss-cone theory, we expect ~10-100 EMRIs to be detected over the observation time of space-based detectors. After many orbital cycles, the EMRI dissipates enough energy and enter the late inspiral phase, and here the complex general-relativistic (GR) effects dominate. When the orbit loses a sufficient amount of energy and angular momentum such that the orbit is no longer stable and plunges towards the MBH. This allows us to test GR in the strong-field regime and use EMRIs to probe the structure of spacetime near MBHs. 

![LoopingDemo](images/plunge_waveform.gif)
*FIG. 4: EMRI trajectory plunge with mass ratio* \\(q=4\times 10^{-7}\\) *and its GW signal. The plunge time to be at \\(t=0\\), and the initial constants of motion are* \\((a, \mathscr{E}, \mathscr{L}, \mathscr{Q})= (0.8,0.95,2.63847, 0.5)\\). *The trajectory and waveform are evolved using [kerrgeopy](https://github.com/BlackHolePerturbationToolkit/KerrGeoPy) and my own time-domain Teukolsky solver [TeukolPy](https://github.com/leiflui/TeukolPy).*

As the secondary rapidly sheds its remaining orbital constants across the Last Stable Orbit (LSO), it breaks from its adiabatic inspiral and accelerates into a dynamic, freefall trajectory. During this terminal plunge, the secondary traverses the light ring—or photon sphere—a critical boundary in Kerr spacetime where strong gravitational lensing allows massless particles to travel in unstable circular orbits. The physics at this threshold are profound, as the GWs generated by the relativistically plunging secondary begin to interact heavily with the effective potential barrier of the central BH.

The extreme spacetime curvature at the light ring causes the emission of high-frequency GWs during the plunge to become temporarily "trapped" within the potential cavity of the photon sphere. Instead of radiating instantaneously to spatial infinity, these wave packets orbit the central MBH, slowly leaking out through the effective potential barrier. This trapping mechanism acts as a resonant cavity that dictates the initial excitation of the BH's quasi-normal modes (QNMs). The geometric properties of the photon sphere essentially filter the outgoing radiation, shaping the precursor to the final ringdown signal even as the secondary is still falling.

Ultimately, the secondary violently crosses the event horizon, culminating the plunge with a peak burst of GW strain. The newly merged system—now a highly perturbed, asymmetric MBH—must rapidly shed its deformations to settle back into a stationary Kerr vacuum state. It accomplishes this through the ringdown phase, radiating its remaining energy as a superposition of QNMs. These modes manifest as exponentially damped sinusoids. According to the No-Hair Theorem, the complex frequencies of these QNMs—their specific oscillation rates and decay timescales—depend exclusively on the mass and spin of the final black hole. Observing this clean, fundamental ringdown spectrum allows us to definitively map the remnant spacetime and perform the ultimate null tests of GR!
